        ...
        if fullJsonParseMode {
            ...
            if let operations = json["operations"] as? [[String: String]] {
                for aptOp in operations {
                    if let type = aptOp["Type"], let packageID = aptOp["Package"] {
                        if type == "Inst", let version = aptOp["CandidateVersion"] {
                            packageInstalls.append([
                                "package": packageID,
                                "version": version
                            ])
                        } else if type == "Remv" || type == "Purg", let version = aptOp["CurrentVersion"] {
                            packageRemovals.append([
                                "package": packageID,
                                "version": version
                            ])
